...
<html lang="en">
    ...
    <body>
        ...
        <a href="images/Budd030.jpg" target="_blank">
            <img src="images/Budd030.jpg" alt="My Wedding Day" width="450" height="600">
        </a>

        <div>Hello Everyone! My name is Ryan Budd and I am a Software Engineer major. This is my third year of attending BYU-I and I am loving every minute of it. 
        ...
        lead to some akward GYM battles but we make do.</div>
        <div>I was born in the Church and have been as faithful as I can be for all my life. I went on a mission to Irvine, California speaking Spanish. I loved
